...
const PORTAL_DATA = {
  ...
  changelog: [
    {
      date: "3 апреля 2026",
      text: "Запущены мгновенные уведомления: входящая почта на ящик команды приходит в рабочую группу в реальном времени. SSL-сертификат и webhook на выделенном домене."
    },
    {
      date: "3 апреля 2026",
      text: "AI-бот подключён к каналу Happy Life и может публиковать напрямую. Процесс утверждения текстов перед публикацией закреплён."
    },
    {
      date: "2 апреля 2026",
