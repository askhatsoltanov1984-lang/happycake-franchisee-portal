...
const PORTAL_DATA = {
  ...
  tasks: [
    ...
    },
    {
      ...
      status: "in_progress",
      description: "Ведётся работа по сокращению времени IVR-меню. Цель — клиент выходит на оператора быстрее. Срок: эта неделя."
    },
    {
  ...
  changelog: [
    {
      date: "17 апреля 2026",
      text: "«Новинки ассортимента Q2» переведены в работу: дегустации проведены, собирается обратная связь. Доработка и поэтапный вывод на сеть по итогам."
    },
    {
      date: "16 апреля 2026",
