...
const PORTAL_DATA = {
  ...
  tasks: [
    ...
    {
      title: "Вечерняя смена call-центра +2 оператора",
      status: "in_progress",
      description: "С 20 апреля 2026 к вечерней смене call-центра добавляются 2 оператора. Цель — снизить очередь и переменную часть IVR-ожидания в пиковое время."
    },
    {
      title: "Push-напоминание о корзине в приложении",
      status: "in_progress",
      description: "В мобильном приложении — push за 3 минуты до истечения корзины: «Ваш десерт ждёт вас в корзине — давайте оформим?». Общее время жизни корзины 10 минут остаётся без изменений."
    },
    // ── ПЛАНИРУЕТСЯ ──
    {
  ...
  changelog: [
    {
      date: "17 апреля 2026",
      text: "IVR-меню сокращено: фикс-часть 9 секунд + переменная реклама от загрузки. С 20 апреля добавляются 2 оператора в вечернюю смену call-центра. В мобильном приложении готовится push-напоминание о корзине за 3 минуты до истечения. «Новинки ассортимента Q2» переведены в работу — дегустации проведены."
    },
    {
      date: "16 апреля 2026",
